...
public class GeneratePic {
    ...
    private static Color fontColors = DefaultColor.white;
    ...
    public static void setFontColors(Color fontColors) {
        GeneratePic.fontColors = fontColors;
    }
